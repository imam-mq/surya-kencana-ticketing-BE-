...
def agent_ticket_pdf(request):
    ...
    # Expose header agar React bisa baca nama filenya
    ...
    draw(f"Dipesan Oleh Agent : {induk_pesanan.pembeli.username}")
