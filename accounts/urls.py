...
urlpatterns = [
    ...
    path("admin/bus/<int:pk>/", admin.admin_bus_detail),
    ...
    path('admin/promo/<int:promo_id>/report/', admin.admin_promo_report),
    path("admin/jadwal/<int:pk>/detail-penumpang/", admin.admin_detail_jadwal_penumpang),
    ...
    path("admin/setoran-pending/", admin.admin_pending_setoran),
    path('admin/transaksi/user-online/', admin.get_transaksi_user_online, name='transaksi-user-online'),
    #Detail PopUp
    ...
    path('order/<int:order_id>/download/', user.download_user_ticket),
